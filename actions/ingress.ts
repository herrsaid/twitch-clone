...
// }catch{
//     throw new Error("canot creat room")
// }

// try{
//     var ingressClient = new IngressClient(process.env.LIVEKIT_API_URL!);
// }catch{
//     throw new Error("canot creat ingress")
// }
...
//     console.log('room & ingress',roomService, ingressClient)
